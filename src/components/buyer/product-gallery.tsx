...
export function ProductGallery({
  ...
  const fallback = "https://placehold.co/800x800/png?text=No+Image";
        ...
        <div className="flex flex-col gap-2">
          {thumbs.slice(0, 7).map((t, i) => (
            <button
              ...
              className={`relative h-12 w-12 cursor-pointer overflow-hidden rounded-sm border-2 transition-colors duration-150 ${
